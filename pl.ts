export const PL = {
  ...
  ScienceFromPowerDesc:
    "Elektrownie wytwarzają niewielką ilość Nauki podczas wytwarzania energii",
  Culture: "Kultura",
  School: "Szkoła",
  ...
  BuildingLocked:
    "Budynek nie jest jeszcze dostępny, musisz go najpierw odblokować w Laboratorium Badawczym",
  ...
  NotEnoughSwissMoney:
    "Niewystarczająca ilość Swiss Money do wykonanie tej akcji",
  ...
  SolarPanelDesc:
    "💡 Panele słoneczne działają tylko 5 sekund na każde 10 sekund - wszystkie cykle są wyrównane",
  WindTurbineDesc:
    "💡 Turbiny wiatrowe działają tylko 8 sekund na każde 10 sekund - cykle nie są równane",
  Movie: "Film",
  ...
  AutoSellCapacityDesc:
    "Maksymalne ilości  produktów  jake mogą  być sprzedawane automatycznie w sekundach/ilość",
  ...
  AutoSellConcurrencyDesc:
    "Maksymalna liczba rodzajów produktów jakie można sprzedawać w tym samamy czasie",
  ...
  MarketCapDesc:
    "Total market capitalization (i.e. market value) of your corporation",
  BuildingValuation: "Wartość twoich budynków",
  BuildingValuationDesc:
    "Łączna wartość twoich budynków, włącznie ze zgodami na budowe i ulepszeniami",
  ...
  SoundDesc:
    "Włącz efekt dźwiękowy, taki jak dźwięk kliknięcia lub dźwięk błędu",
  AutoHighlight: "Automatyczne podświetlanie",
  AutoHighlightDesc:
    "Automatycznie podświetlaj budynki tego samego typu po wybraniu budynku",
  MusicDesc:
    "Włącz muzykę: It's Not Over 'Til The Bossa Nova by Shane Ivers (https://www.silvermansound.com)",
  Credits: "Credits",
  Icons: "Ikony",
  MisplacedBuilding:
    "⛔ Ten %{building} nie jest umieszczany na odpowiednim depozycie zasobów",
  ...
  HighlightMaxInputDistanceNotDefault:
    "...z maksymalnym zasięgiem poboru surowców < ∞",
  ...
  InputStrategyCloseDesc:
    "Wybieraj magazyny znajdujące sie najbliżej i posiadające wystarczającą ilość surowców",
  InputStrategyFar: "Najdalsze",
  InputStrategyFarDesc:
    "Wybieraj magazyny znajdujące sie najdalej i posiadające wystarczającą ilość surowców",
  InputStrategyAmount: "Ilość",
  InputStrategyAmountDesc:
    "Wybieraj magazyny posiadające największość ilość zasobów, niezależnie od dystansu",
  ...
  EffectiveTimeDesc:
    "Twój efektywny czas zarabiania offline jest ograniczony do %{time}min.",
  ...
  PolicyPointDesc:
    "💡 Im więcej aktywnych patentów, tym więcej punktów patentowych zostaje zużytych",
  ...
  PolicyOilWellPowerx2Desc:
    "Szyby naftowe produkują 2x więcej ropy i zużywają 2x więcej moc",
  HalfTransportSpeed: "Zwolnij, aby zaoszczędzić",
  HalfTransportSpeedDesc:
    "Prędkość transportu zostaje zmniejszona o 25%, a koszt paliwa zmniejszony o 25%",
  RefineryMoreOil: "Rafineria Potrzebuje Więcej ropy",
  RefineryMoreOilDesc:
    "Rafinerie ropy naftowej produkują o 50% więcej benzyny i 50% mniej plastiku",
  RefineryMorePlastic: "Rafineria Potrzebuje Więcej plastiku",
  RefineryMorePlasticDesc:
    "Rafinerie ropy naftowej produkują o 50% mniej benzyny i 50% więcej plastiku",
  FreeOilTransportDesc:
    "Transport ropy nie zużywa paliwa, ale szyby naftowe zużywają 2x moc",
  SuperSteelMill: "Serca z żelaza",
  SuperSteelMillDesc:
    "Huty zużywają o 50% mniej węgla, a 25% więcej żelaza i 25% więcej mocy",
  ...
  CostSaverDesc:
    "Jeśli nakłady finansowe  na budynek kosztują więcej niż jego produkcja, zamknij produkcję",
  ...
  CostSaverBuildingWarning:
    "Polityki oszczędności kosztów jest aktywna, nie można ręcznie zmienić produkcji",
  GlassUseCoal: "Czarne szkło",
  GlassUseCoalDesc:
    "Fabryki szkła zużywają o 50% więcej węgla i 50% mniej krzemu",
  ...
  IronMine2xOutputDesc:
    "Kopalnie żelaza produkują 2x więcej żelaza, ale transport żelaza kosztuje 2x wiecej  paliwa",
  SolarPanelAlwaysWork: "Słońce nigdy nie zachodzi",
  SolarPanelAlwaysWorkDesc:
    "Panele słoneczne działają przez 100% czasu, ale wytwarzają o 60% mniej energii",
  ...
  CrAlloyUseFe: "chrom",
  CrAlloyUseFeDesc:
    "Zakłady produkujące stopy chromu nie używają litu, ale zamiast tego używają 2x więcej żelaza",
  DoubleTileModifier: "Siła Natury",
  TileModifierOutputOnly: "Modyfikatory płytek Dodatkowych",
  GasPlantPetrol: "Likwidator gazu",
  GasPlantPetrolDesc:
    "Elektrownie gazowe zużywają dodatkowy gaz do produkcji benzyny",
  CoalPlantFuel: "Zmiękczacz węgla",
  CoalPlantFuelDesc:
    "Elektrownie węglowe wykorzystują dodatkowy węgiel do produkcji benzyny",
  Welcome: "Witamy!",
  ...
  SaveName: "Zapisz",
  NameValidationRule:
    "Twoja nazwa powinno zawierać tylko litery i cyfry oraz mieć od 5 do 15 znaków",
  NameValidationRuleProfanity: "Twoja nazwa  nie powinno zawierać wulgaryzmów",
  ChatMessageRateLimit:
    "Możesz wysłać nową wiadomość dla czatu tylko co 10 sekund",
  NameSaved: "Twoja nazwa zostało pomyślnie zmienione",
  NoMessages: "Brak nowych wiadomości",
  Leaderboard: "Tablica wyników",
  Name: "Nazwa",
  Tips1:
    "Oceny akcji mają 5 poziomów: kup, przewyższaj, trzymaj, poniżej wyników i sprzedawaj",
  Tips2:
    "Budynki przestaną transportować zasoby, jeśli jest ich już wystarczająco do produkcji, chyba że włączysz tryb gromadzenia zasobów",
  Tips3:
    "Koszt paliwa do transportu zasobów zależy od odległości i ilości zasobów",
  Tips4:
    "Budynki będą transportować zasób tylko wtedy, gdy ilość znaleziona na mapie przekracza pojemność wejściową",
  Tips5:
    "Budynki będą transportować zasoby z Centrum Handlowego tylko wtedy, gdy automatyczna sprzedaż jest wyłączona dla tego zasobu",
  Tips6:
    "Możesz zobaczyć koszt paliwa dla zasobu w odpowiedniej sekcji pojemności wejściowej",
  Tips7:
    "Jeśli kupisz zasób, podniesiesz cenę. Jeśli sprzedasz zasób, obniżysz cenę",
  Tips8:
    "Możesz zobaczyć wykres dla ilości każdego zasobu i jego zmiany w czasie w Biurze Statystycznym",
  Tips9:
    "Punkty badań potrzebne do budowy budynków są określane przez cenę rynkową jego zasobów wejściowych",
  Tips10:
    "Różne zasoby są różnie wyceniane na rynku - zawsze bądź przygotowany na zmienność rynku",
  Tips11:
    "Przed rozszerzeniem produkcji warto zawsze sprawdzić stan zasilania i paliwa",
  ...
  RequireExpansionPack1Desc:
    "Jest to dostępne tylko dla dodatku Expansion Pack 1",
  RequireAnyExpansionPack: "Ekskluzywne pakiety rozszerzeń",
  RequireAnyExpansionPackDesc:
    "Ta funkcja wymaga posiadania co najmniej jednego z dodatków",
  ...
  BuildingPermitCostDividerDesc:
    "Podziel koszt pozwoleń na budowę przez ten dzielnik",
  ExtraAdjacentBonus: "Dodatkowe sąsiednie bonusy",
  ExtraAdjacentBonusDesc:
    "Dodatkowa pojemność dla każdego sąsiedniego, działającego budynku tego samego typu",
  ...
  ClaimTradeFail:
    "Nie udało się odebrać  tej transakcji, spróbuj ponownie później",
  CancelTradeSuccess: "Twoja transakcja została pomyślnie anulowana",
  CancelTradeFail:
    "Nie udało się anulować tej transakcji, spróbuj ponownie później",
  AcceptTradeFail:
    "Nie udało się zaakceptować tej transakcji, spróbuj ponownie później",
  ...
  FailedToImportSaveDesc:
    "Twój plik zapisu jest niezgodny lub uszkodzony: %{error}",
  SaveCopiedToClipboard: "Twoje dane zapisu zostały skopiowane do schowka",
  CancelActiveTradeFirst:
    "Masz aktywne transakcje gracza, najpierw je anuluj lub odbierz",
  ...
  PlayerTradeToClaim:
    "Ty masz %{num} nowych transakcj ubieganych  się o wymianę z graczami",
  PowerBank: "Przenośna Ładowarka",
  PowerBankBuildDesc:
    "Przechowuj nadwyżkę mocy i zapewnij zasilanie podczas niedoboru",
  WarehouseBuildDesc:
    "Transportuj i przechowuj dowolne zasoby przy niższych kosztach zużycia  paliwa",
  ...
  PowerBankMoreCapacityDesc:
    "Przenośne Ładowarki ładują się z 50% szybkości, ale mają o 50% większą pojemność",
  PowerBankNotWorking: "⛔ Przenośne Ładowarki działają tylko obok elektrowni",
  ColorTheme: "Motywy kolorystyczne",
  ColorThemeDesc:
    "Motyw kolorystyczny dla ikon gry, podświetlenia, siatki i tła. WYMAGA PONOWNEGO ZAŁADOWANIA",
  ...
  AlMine2xOutputDesc:
    "Kopalnie aluminium produkują 2x więcej aluminium i zużywają 2x więcej mocy",
  LoggingCamp2xOutput: "Wylesianie",
  LoggingCamp2xOutputDesc:
    "Obozy drwali produkują 2x więcej drewna, a transport drewna kosztuje 2x więcej paliwa",
  PowerBankLeft: "Przenośna Ładowarkak",
  ColorThemeEditor: "Edytor motywów kolorystycznych",
  ColorThemeEditorDesc:
    "Możesz zastąpić kolory w bieżącym motywie kolorystycznym. Obecnie masz %{num} nadpisuje",
  ...
  HideChatMentionsDesc:
    "Ukryj powiadomienie dźwiękowe i toastowe, gdy w czacie pojawia się wzmianka o mnie,",
  ...
  WarehouseAddRouteFail:
    "Nie udało się dodać trasy: wybrany kafelek nie jest prawidłowym źródłem",
  LevelN: "Poziom %{level}",
  Surplus: "Nadwyżka",
  Production: "Produkcja",
  Consumption: "Konsumpcja",
  WarehouseInputCapacityDescV2:
    "Całkowita pojemność transportu wewnętrznego, podzielona równo na wszystkie trasy",
  ...
  WindTurbineAlwaysWorkDesc:
    "Turbiny wiatrowe pracują przez 100% czasu, ale wytwarzają o 30% mniej energii",
  ...
  BatteryFuelEconomyDesc:
    "Zużycie paliwa w akumulatorze poprawia się o 100% (50% kosztów paliwa)",
  ShowTheoreticalInputOutputCapacity:
    "Pokaż teoretyczną pojemność wejściową/wyjściową",
  ...
  ClaimTradeSuccessV2:
    "Twoja transakcja została pomyślnie potwierdzona: %{cashOrResource}",
  AcceptTradeSuccessV2:
    "Ten handel został przez Ciebie zaakceptowany: %{cashOrResource}",
  ...
  PlayerTradeOptOut:
    "Zrezygnowałeś z tabeli liderów, nie możesz handlować z innymi graczami",
  FirstTimeReadGuide:
  ...
  ReadSteamGuideV2Desc:
    "Możesz czytać poradniki stworzone przez społeczność na Steamie - możesz też tworzyć własne",
  ChatMessageTooLong:
    "Twoja wiadomość na czacie przekracza maksymalną dozwoloną liczbę znaków",
  ...
  SteamLoginDesc:
    "Jeśli posiadasz dodatki na Steam, możesz grać z dodatkami w sieci po zalogowaniu",
  ...
  AchievementsRewardToast:
    "Odebrałeś nagrodę: Szwajcarskie pieniądze +%{swiss}",
  ...
  AchievementStockholm100Desc:
    "Zarób 100 szwajcarskich pieniędzy w Sztokholmie w jednym biegu",
  AchievementStockholm500: "Absolwent Wikingów",
  AchievementStockholm500Desc:
    "Zarób 500 szwajcarskich pieniędzy w Sztokholmie w jednym biegu",
  AchievementStockholm1000: "Doświadczony wiking",
  AchievementStockholm1000Desc:
    "Zarób 1000 szwajcarskich pieniędzy w Sztokholmie w jednym biegu",
  AchievementOslo100: "Norweski hobbysta olejowy",
  AchievementOslo100Desc:
    "Zarób 100 szwajcarskich pieniędzy w Oslo w jednym biegu",
  AchievementOslo500: "Norweski entuzjasta ropy",
  AchievementOslo500Desc:
    "Zarób 500 szwajcarskich pieniędzy w Oslo w jednym biegu",
  AchievementOslo1000: "Norweski potentat naftowy",
  AchievementOslo1000Desc:
    "Zarób 1000 szwajcarskich pieniędzy w Oslo w jednym biegu",
  AchievementRotterdam100: "Właściciel Wiatraczka",
  AchievementRotterdam100Desc:
    "Zarób 100 szwajcarskich pieniędzy w Rotterdamie w jednym biegu",
  AchievementRotterdam500: "Właściciel wiatraka",
  AchievementRotterdam500Desc:
    "Zarób 500 szwajcarskich pieniędzy w Rotterdamie w jednym biegu",
  AchievementRotterdam1000: "Właściciel turbiny wiatrowej",
  AchievementRotterdam1000Desc:
    "Zarób 1000 szwajcarskich pieniędzy w Rotterdamie w jednym biegu",
  AchievementDetroit100: "Lokalny dealer samochodowy",
  AchievementDetroit100Desc:
    "Zarób 100 szwajcarskich pieniędzy w Detroit w jednym biegu",
  AchievementDetroit500: "Regionalny Dystrybutor Samochodów",
  AchievementDetroit500Desc:
    "Zarób 500 szwajcarskich pieniędzy w Detroit w jednym biegu",
  AchievementDetroit1000: "Narodowy monopol samochodowy",
  AchievementDetroit1000Desc:
    "Zarób 1000 szwajcarskich pieniędzy w Detroit w jednym biegu",
  AchievementBoston100: "Licencjat Zarabiania Pieniędzy",
  AchievementBoston100Desc:
    "Zarób 100 szwajcarskich pieniędzy w Bostonie w jednym biegu",
  AchievementBoston500: "Mistrz zdobywania pieniędzy",
  AchievementBoston500Desc:
    "Zarób 500 szwajcarskich pieniędzy w Bostonie w jednym biegu",
  AchievementBoston1000: "Doktorat z drukowania pieniędzy",
  AchievementBoston1000Desc:
    "Zarób 1000 szwajcarskich pieniędzy w Bostonie w jednym biegu",
  AchievementRome100: "Dioklecjan",
  AchievementRome100Desc:
    "Zarób 100 szwajcarskich pieniędzy w Rzymie w jednym biegu",
  AchievementRome500: "Konstantyn Wielki",
  AchievementRome500Desc:
    "Zarób 500 szwajcarskich pieniędzy w Rzymie w jednym biegu",
  AchievementRome1000: "Cezar August",
  AchievementRome1000Desc:
    "Zarób 1000 szwajcarskich pieniędzy w Rzymie w jednym biegu",
  AchievementHamburg100: "Niemcy",
  AchievementHamburg100Desc:
    "Zarób 100 szwajcarskich pieniędzy w Hamburgu w jednym biegu",
  AchievementHamburg500: "Ojczyzna",
  AchievementHamburg500Desc:
    "Zarób 500 szwajcarskich pieniędzy w Hamburgu w jednym biegu",
  AchievementHamburg1000: "Hrabia Zeppelin",
  AchievementHamburg1000Desc:
    "Zarób 1000 szwajcarskich pieniędzy w Hamburgu w jednym biegu",
  AchievementToulouse100: "Odrzutowiec A310",
  AchievementToulouse100Desc:
    "Zarób 100 szwajcarskich pieniędzy w Tuluzie w jednym biegu",
  AchievementToulouse500: "Odrzutowiec A330",
  AchievementToulouse500Desc:
    "Zarób 500 szwajcarskich pieniędzy w Tuluzie w jednym biegu",
  AchievementToulouse1000: "Odrzutowiec A380",
  AchievementToulouse1000Desc:
    "Zarób 1000 szwajcarskich pieniędzy w Tuluzie w jednym biegu",
  AchievementHongKong100: "Hobbysta handlarz",
  AchievementHongKong100Desc:
    "Zarób 100 szwajcarskich pieniędzy w Hongkongu w jednym biegu",
  AchievementHongKong500: "Profesjonalny Broker",
  AchievementHongKong500Desc:
    "Zarób 500 szwajcarskich pieniędzy w Hongkongu w jednym biegu",
  AchievementHongKong1000: "Zarządzający funduszem hedgingowym",
  AchievementHongKong1000Desc:
    "Zarób 1000 szwajcarskich pieniędzy w Hongkongu w jednym biegu",
  AchievementStPetersburg100: "Wielki Książę",
  AchievementStPetersburg100Desc:
    "Zarób 100 szwajcarskich pieniędzy w Petersburgu w jednym biegu",
  AchievementStPetersburg500: "Carewicze",
  AchievementStPetersburg500Desc:
    "Zarób 500 szwajcarskich pieniędzy w Petersburgu w jednym biegu",
  AchievementStPetersburg1000: "Car Wszechrusi",
  AchievementStPetersburg1000Desc:
    "Zarób 1000 szwajcarskich pieniędzy w Petersburgu w jednym biegu",
  AchievementOsaka100: "Danshaku",
  AchievementOsaka100Desc:
    "Zarób 100 szwajcarskich pieniędzy w Osace w jednym biegu",
  AchievementOsaka500: "Hakushaku",
  AchievementOsaka500Desc:
    "Zarób 500 szwajcarskich pieniędzy w Osace w jednym biegu",
  AchievementOsaka1000: "Kōshaku",
  AchievementOsaka1000Desc:
    "Zarób 1000 szwajcarskich pieniędzy w Osace w jednym biegu",
  SteamAutoCloudBackup: "Automatyczna kopia zapasowa Steam Cloud",
  SteamAutoCloudBackupFailed:
    "Automatyczna kopia zapasowa Steam Cloud nie powiodła się: %{error}",
  ...
  ElectricCarDesc:
    "Fabryki samochodów używają baterii zamiast benzyny i wymagają tylko 50% kwoty",
  HongKongBonusV2:
  ...
  SettingsFullScreenDesc:
    "Uruchom grę w trybie pełnoekranowym. Dostępne tylko dla wersji Steam",
  LeaderboardByAllPrestigeCurrency:
    "Zarobione szwajcarskie pieniądze przez cały czas",
  ...
  PlayerTradePriceNotValidV2:
    "Cena handlowa musi być pomiędzy %{min} oraz %{max}",
  ...
  PlasticFiberDesc:
    "Fabryki włókien zużywają o 50% więcej tworzyw sztucznych, ale o 50% mniej szkła",
  NewsEffectx2: "Konferencja prasowa",
  NewsEffectx2Desc:
    "Podwaja się efekt wiadomości rynkowych – zarówno pozytywnych, jak i negatywnych",
  ...
  BuilderMoveSpeedDesc:
    "Szybkość, jaką poruszają się budowniczowie, aby wznosić budynki",
  EBookInc: "eBook Inc",
  ResourceBooster: "Wzmacniacz zasobów",
  BuildWarningTitle: "Budynek może nie działać",
  BuildWarningTitleDesc:
    "%{reason}. Czy na pewno będziesz budować na tym kafelku??",
  BuildWarningBuildAnyway: "Buduj mimo to",
  ResourceBoosterNotWorking:
    "⛔ Wzmacniacze surowców działają tylko obok kopalni złóż",
  ResourceBoosterBuildings: "Wzmacnianie budynków",
  BuildingResourceConversion: "%{resource} Konwersja",
  AllTimeSwissMoneyEarned:
    "Zarobione szwajcarskie pieniądze przez cały czas: %{number}",
  ...
  ItsAllGreenDesc:
    "Posiadaj 50 linii produkcyjnych i żadnego deficytu produkcyjnego",
  DeepInRed: "Głęboko w czerwieni",
  DeepInRedDesc:
    "Posiadaj 50 linii produkcyjnych, które mają deficyt produkcji",
  UseScientificNotation: "Użyj notacji naukowej",
  UseScientificNotationDesc:
    "Użyj notacji naukowej (notacji e) dla liczb większych niż 999,9T",
  LogoutDescV2:
  ...
  BuildingUpgradeCostDividerDescV2:
    "Podziel koszt ulepszenia budynku przez ten dzielnik",
  ...
  ChangeNameCooldown:
    "Możesz zmienić swoje imię tylko raz na raz %{hour} godzin",
  ...
  SteelMillx2Desc:
    "Stalownie i zakłady ze stali nierdzewnej mają 2x lepszą wydajność, ale zużywają 2x więcej  mocy",
  FuelDynamite: "Dynamitowego Paliwa",
  FuelDynamiteDesc:
    "Fabryki dynamitu wykorzystują twoje obecne paliwo zamiast oleju",
  StPetersburgBonusV2:
  ...
  BuildingPermitsNeededDesc:
    "Ten budynek nie działa, ponieważ nie masz wystarczających pozwoleń na budowę",
  ...
  GasPumpx2OutputDesc:
    "Pompy gazu ziemnego mają 2x więcej  mocy, ale zużywają 2x więcej mocy",
  LeaderboardValuationPerHour: "Całkowita wycena na godzinę",
  LeaderboardValuationPerHourPerSwiss:
    "Całkowita wycena na godzinę na szwajcary",
  LeaderboardValuationPerHourNewPlayers:
    "Całkowita wycena na godzinę (< 1000 szwajcarski)",
  ...
  MapExtraPermitDesc:
    "Otrzymasz %{number} darmowych pozwoleń na budowę z unikalnego bonusu mapy",
  OsloBonusV3:
  ...
  ResourceBoosterPercentageV2:
    "💡 Ta kwota obejmuje %{percent} doładowania z sąsiednich wzmacniaczy zasobów",
  MapleSyrup: "Syrop klonowy",
  MapleSyrupFactory: "Fabryka syropu klonowego",
  SyrupPlastic: "Syrop z tworzywa sztucznego",
  SyrupPlasticDesc:
    "Wszystkie budynki, do których trafiają tworzywa sztuczne, używają zamiast tego syropu klonowego",
  ...
  ProductionDiversificationDesc:
    "Każdy inny typ budynku daje 1% dodatkowej pojemności wszystkim budynkom",
  ExtraPolicyPointsDescV2:
    "Centrum polis ma 2x więcej  zdolność konwersji punktów polisy",
  PowerRequired: "Wymagana moc",
  AchievementVancouver100: "Sprzedawca soków",
  AchievementVancouver100Desc:
    "Zarób 100 szwajcarskich pieniędzy w Vancouver w jednym biegu",
  AchievementVancouver500: "Syrop Savant",
  AchievementVancouver500Desc:
    "Zarób 500 szwajcarskich pieniędzy w Vancouver w jednym biegu",
  AchievementVancouver1000: "Zdobywca Canuck",
  AchievementVancouver1000Desc:
    "Zarób 1000 szwajcarskich pieniędzy w Vancouver w jednym biegu",
  BarbariansAtTheGate: "Barbarzyńcy przy bramie",
  BarbariansAtTheGateDesc:
    "Wykorzystaj limit handlowy gracza o wartości 1 biliona między aktualizacjami rynku",
  DiversifiedProductions: "Zróżnicowane produkcje",
  DiversifiedProductionsDesc:
    "Zbuduj 100 różnych typów budynków na jednej mapie",
  ...
  PledgeSuccessful:
    "Zobowiązałeś się do %{amount} finansowania społecznościowego",
  ...
  HighPowerPriorityDesc:
    "Włączenie tego spowoduje, że budynek będzie pobierał energię przed innymi budynkami",
  IndustryZone: "Strefa Przemysłu",
  IndustryZoneDesc:
    "Połącz sąsiednie budynki, które tworzą łańcuch dostaw i oszczędzaj pozwolenia na budowę",
  ...
  IndustryZoneNoAdjacentBonus:
    "Ten budynek jest częścią strefy przemysłowej i nie ma przyległego bonusu",
  ...
  WarehouseBuildingPermitSaveDesc:
    "Każde dwa magazyny dają jedno bezpłatne pozwolenie na budowę",
  PolicySearchPlaceholder: "Wpisz nazwę polityki do wyszukania",
  SwissUpgrade: "Szwajcarskie Ulepszenia",
  SwissUpgradeDesc:
    "Szwajcarskie aktualizacje są stałe i zostaną przeniesione, jeśli zaczniesz w nowym mieście",
  ...
  OfflineEarningDescV2:
    "Zarabianie offline zależy od Twoich aktualnych badań, produkcji i sprzedaży samochodów",
  ...
  CrowdfundingBackersReturn:
    "Wspierający: %{backers}, Bieżący zwrot: %{return}",
  ...
  AchievementSanJose100Desc:
    "Zarób 100 szwajcarskich pieniędzy w San Jose w jednym biegu",
  AchievementSanJose500: "Entuzjasta przedsięwzięć",
  AchievementSanJose500Desc:
    "Zarób 500 szwajcarskich pieniędzy w San Jose w jednym biegu",
  AchievementSanJose1000: "Venture Capitalist",
  AchievementSanJose1000Desc:
    "Zarób 1000 szwajcarskich pieniędzy w San Jose w jednym biegu",
  AchievementCrowdfundingTycoon: "Potentat crowdfundingowy",
  AchievementCrowdfundingTycoonDesc:
    "Zastaw zasobów o wartości 1Qa w ramach jednego finansowania społecznościowego",
  ...
  PumpkinBatteryDesc:
    "Wszystkie budynki, które zużywają baterię, używają zamiast tego dyni",
  PumpkinSteel: "Stal dyniowa",
  PumpkinSteelDesc:
    "Wszystkie budynki, które zużywają stal, używają zamiast tego dyni",
  RequireExpansionPack2: "Dodatek 2",
  ExpansionPack2: "Dodatek 2",
  RequireExpansionPack2Desc:
    "Jest to dostępne tylko dla dodatku Expansion Pack 2",
  Reindeer: "Renifer",
  ReindeerSilicon: "Renifer Krzem",
  ReindeerSiliconDesc:
    "Wszystkie budynki, które zużywają krzem, wykorzystują zamiast tego renifery",
  ReindeerAluminum: "Renifer Aluminium",
  ReindeerAluminumDesc:
    "Wszystkie budynki, które zużywają aluminium, wykorzystują zamiast tego renifery",
  ...
  RandomIslandBonus:
    "<li>Mapa jest losowana za każdym razem, gdy zaczynasz</li><li>Rozmiar mapy, rodzaj siatki, depozyty zasobów i unikalne bonusy są losowo generowane</li><li>Jest 5-minutowy czas odnowienia - ponowne losowanie odbywa się tylko w odstępie co najmniej 5 minut</li>",
  RandomIslandBonusDesc:
    "Unikalny bonus na Losowej Wyspie jest wymieniany za każdym razem, gdy zaczynasz na mapie",
  RandomIslandBonusCapacity: "%{building} ma %{multiplier}x Pojemnośći",
  RandomIslandBonusProductivity: "%{building} ma %{multiplier}x wydajnośći",
